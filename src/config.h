...
// ─── World ────────────────────────────────────────────────
#define WORLD_SIZE     750         // world is WORLD_SIZE x WORLD_SIZE tiles
#define TILE_SIZE      24          // pixels per tile (between the old chunky
                                   // 30 and Factorio's fine grain)
#define TREE_CHANCE    1.3           // % of MEADOW tiles that start as trees
#define ROCK_CHANCE    0.8          // % of MEADOW tiles that start as rocks
...
#define INFESTATION_PATCHES 9      // how many enemy patches to scatter
#define INFESTATION_RADIUS  14     // patch radius in tiles
#define FOW_REVEAL_TILES    35     // fog-of-war reveal radius around you
...
#define ORE_METAL_PATCHES   25     // metal fields
...
#define ORE_PATCH_RADIUS_MAX 14
...
#define MACHINE_FUEL_MAX    100    // coal a machine can hold at once

// ─── Player ─────────────────────────────────────────────────
#define PLAYER_SPEED   330.0f      // pixels per second (~14 tiles/s)
#define PLAYER_RADIUS  7.0f        // size of the player circle
#define PLAYER_REACH   200.0f       // max distance (px) you can mine/place
...
#define PISTOL_BULLET_SPEED 1800.0f     // pistol bullet speed
#define SLINGSHOT_BASE_DAMAGE 4.0f      // max damage from a stone projectile
#define PISTOL_BULLET_DAMAGE 9.0f       // max damage from a pistol bullet
#define HAND_DPS            1.0f        // mining damage/second with empty hands
#define PLAYER_MAX_HP       100.0f      // you can die now — build a base!
#define SMG_FIRE_INTERVAL   0.10f       // seconds between SMG shots (hold LMB)
...
#define WAVE_SIZE           8.0f        // brood size that triggers a march —
...
#define BOMB_RADIUS         100.0f       // explosion radius in px (2.5 tiles)
